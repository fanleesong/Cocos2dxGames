(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/MyUtils.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '179cfCSD6BHxa/+eizYGkX4', 'MyUtils', __filename);
// Script/MyUtils.js
...
(function (global, factory) {
    ...
    /* AMD */if (typeof define === 'function' && define["amd"]) define(["MyUtils"], factory);
    /* CommonJS */else if (typeof require === "function" && (typeof module === "undefined" ? "undefined" : _typeof(module)) === "object" && module && module["exports"]) module["exports"] = factory(require("MyUtils"), true);
        /* Global */else (global["dcodeIO"] = global["dcodeIO"] || {})["MyUtils"] = factory(global["dcodeIO"]["MyUtils"]);
})(undefined, function (MyUtils, isCommonJS) {
    "use strict";
    //MyUtils 
